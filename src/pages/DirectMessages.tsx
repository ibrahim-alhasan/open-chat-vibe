...
const DirectMessages = ({ 
  ...
  // The conversation list and message nodes render asynchronously. Waiting for
  // two animation frames makes opening a DM reliably land on the newest message
  // even when avatars or signed media finish loading a moment later.
  useEffect(() => {
  ...
  }, [activeConversation, conversationMessages.length, loadingMessages]);
        ...
        {activeConversation && activeProfile ? (
          <div className="flex items-center justify-between flex-1">
            ...
            <MaterialIconButton
              ...
              ariaControls={headerMenuAnchor ? "dm-header-menu" : undefined}
              ariaHasPopup="menu"
            ...
            {isConversationBlocked ? (
              ...
              <div className="flex items-end gap-2 p-2 rounded-2xl" style={{ background: "hsl(var(--chat-input-bg))", border: "1px solid hsl(var(--border))" }}>
                ...
                <MaterialIconButton
                  ...
                  className={`chat-send-button ${(input.trim() || selectedImage) && !sending ? "is-ready" : ""}`}
                  onClick={handleSend}
